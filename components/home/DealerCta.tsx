      ...
      <div className="container-content">
        <div className="relative">
          ...
          <div className="relative z-10 -mt-12 mr-6 ml-6 max-w-[44rem] bg-warm-white p-7 sm:-mt-20 sm:p-10 lg:absolute lg:bottom-12 lg:left-12 lg:m-0 lg:p-12">
            <h2
              data-reveal
              className="text-[clamp(2.25rem,4.6vw,4.75rem)] leading-[0.98] font-medium tracking-[-0.03em] text-charcoal"
            >
              {content.title}
            </h2>
            <p
              data-reveal
              className="mt-6 max-w-[44ch] text-body-l text-charcoal-soft"
            >
              {content.body}
            </p>
