...
export const pagesContent: PagesContent = {
  theHomelift: {
    opening: {
      ...
      aside: {
        drawing: "section",
        title: "Section through a house with the cabin at the upper floor",
        desc: "The staircase rises from the lower floor to the upper floor. The cabin, in the space beneath it, has arrived at the upper floor.",
        caption: "Schematic section. Not to scale.",
      },
    },
    mechanism,
    blocks: [
  ...
  inYourHome: {
    opening: {
      ...
      aside: {
        drawing: "plan",
        title: "Plan of a hall with the cabin at the head of the flight",
        desc: "Seen from above: a straight staircase against a wall, with the cabin occupying the footprint at the head of the flight.",
        caption: "Schematic plan. Not to scale.",
      },
  ...
  installation: {
    opening: {
      ...
      aside: {
        drawing: "section",
        title: "Section through a house with the system installed",
        desc: "The staircase, the space beneath it, and the cabin in that space, as the installation leaves them.",
        caption: "Schematic section. Not to scale.",
      },
  ...
  information: {
    opening: {
      ...
      aside: {
        drawing: "plan",
        title: "Plan of a hall with the cabin at the head of the flight",
        desc: "Seen from above: a straight staircase against a wall, with the cabin occupying the footprint at the head of the flight. No dimension is shown; dimensions are published when they are confirmed.",
        caption: "Schematic plan. No dimension is shown until it is confirmed.",
      },
    },
